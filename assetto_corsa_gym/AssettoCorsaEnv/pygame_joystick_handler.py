...
class JoystickHandler:
    ...
    def initialize(self):
        ...
        if pg.joystick.get_count() > 0:
            ...
            self._joystick.init()
            self.logger.info(self._joystick.get_init())
            self.logger.info(self._joystick.get_id())
            self.logger.info(self._joystick.get_name())
            self.logger.info(self._joystick.get_numaxes())
            self.logger.info(self._joystick.get_numballs())
            self.logger.info(self._joystick.get_numbuttons())
            self.logger.info(self._joystick.get_numhats())
